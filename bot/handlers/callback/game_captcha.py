...
from config import CAPTCHA_ROUTE, HOST, INVALIDATE_STATE_MINUTES, PROXY_PREFIX
from utils.security import generate_user_secret


async def callback_game_captcha(query: types.CallbackQuery, captcha_storage: RedisStorage, captcha_state: FSMContext, bot: Bot):
